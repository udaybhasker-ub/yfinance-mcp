...
class TestJqOrJson:
    ...
    def test_complex_template(self) -> None:
        ...
        template = textwrap.dedent("""\
            ...
            .summary.count
        """)
        result = jq_or_json(SAMPLE_DATA, template)
        lines = result.strip().splitlines()
